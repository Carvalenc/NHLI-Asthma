...
! git remote add origin https://github.com/Carvalenc/NHLI-Asthma.git
...
Now we can generate clean up the data. Below I am using my region classifications that I use in the stream plots:
...
graph export /figures/region_deaths.png
